...
public class ReadConfigurations
{
    public static void readConfigurations(String[]args) throws IOException 
	{
        ...
        for (int k=0; k < args.length; k++)
        {
    		...
    		else if (args[k].equals("-fnTrainingData")) Data.fnTrainData = args[++k];
    	...
    	System.out.println("fnTrainingData: " + Data.fnTrainData);
        ...
        try {
			...
			Data.bw.write("fnTrainingData: " + Data.fnTrainData + "\r\n");
